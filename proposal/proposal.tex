...
\]
where $m_j$ is the mass of particle $j$, $W$ is the smoothing kernel with support radius $h$, and $r_{ij} = |\mathbf{r}_i - \mathbf{r}_j|$.
...
\[
\mathbf{f}_i^{surface} = -\sigma \sum_j m_j \frac{\mathbf{r}_{ij}}{r_{ij}} \nabla W(r_{ij}, h)
\]
